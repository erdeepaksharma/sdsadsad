 ...
 * @version    $Id: EditorMail.php 6590 2013-04-01 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitereview_Form_Editor_EditorMail extends Engine_Form {
    ...
    public function init() {
        ...
        $this->setTitle('Email Editor')
                ...
                ->setAttrib('name', 'sitereviews_editor_mail');
