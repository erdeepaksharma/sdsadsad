 ...
 */
class Sitereview_Form_Review_Create extends Engine_Form {
    ...
    public function init() {
        ...
        if ($widgetSettingsReviews['sitereview_proscons']) {
            if ($widgetSettingsReviews['sitereview_limit_proscons']) {
                $this->addElement('Textarea', 'pros', array(
                    ...
                    'allowEmpty' => false,
                    'maxlength' => $widgetSettingsReviews['sitereview_limit_proscons'],
                    'required' => true,
                    'filters' => array(
                        'StripTags',
                        new Engine_Filter_Censor(),
        ...
        if ($widgetSettingsReviews['sitereview_recommend']) {
        ...
        $this->addElement('Button', 'submit', array(
            ...
            'order' => 10,
            'type' => 'submit',
            'onclick' => "return submitForm('0', $('sitereview_create'), 'create');",
            'ignore' => true
        ));
    }
