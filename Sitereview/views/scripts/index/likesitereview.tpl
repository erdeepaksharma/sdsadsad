 ...
 * @version    $Id: likesitereview.tpl 6590 2013-04-01 00:00:00Z SocialEngineAddOns $
...
<script type="text/javascript">
 ...
 var url = en4.core.baseUrl + 'sitereview/index/likesitereview';// URL where send ajax request.
	function show_myfriend () {
		$('sitereviews_popup_content').innerHTML = '<center><img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/sitereview/externals/images/loading.gif" /></center>';
      en4.core.request.send(new Request.HTML({
        ...
        'data' : {
          ...
          'search' : this.value,
			...
			$('sitereviews_popup_content').innerHTML = responseHTML;
			}
    }));
  }
    ...
    $('like_members_search_input').addEvent('keyup', function(e) {
		$('sitereviews_popup_content').innerHTML = '<center><img src="<?php echo $this->layout()->staticBaseUrl?>application/modules/Sitereview/externals/images/loading.gif" alt="" class="mtop10" /></center>';
      en4.core.request.send(new Request.HTML({
        'url' : url,
        'data' : {
          'format' : 'html',
...
<?php  if(empty($this->is_ajax)) { ?>
	...
	<div class="seaocore_members_popup">
		<div class="top">
			<?php 
				...
				elseif($this->resource_type == 'sitereview_listing') {
	...
	<div class="seaocore_members_popup_content" id="sitereviews_popup_content">
<?php } ?>
