 ...
 * @version    $Id: MetaReview.php 6590 2013-04-01 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitereview_Model_DbTable_MetasReview extends Engine_Db_Table {

  protected $_name = 'sitereview_review_fields_meta';
  ...
  public function getProfileFieldsReview($map_id) {
    ...
    $maptable = Engine_Api::_()->getDBTable('mapsReview', 'sitereview');
