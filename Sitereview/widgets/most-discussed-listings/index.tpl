      ...
      <?php foreach ($this->listings as $sitereview): ?>
        <li> 
          ...
          <div class='seaocore_sidebar_list_info'>
            ...
            <div class='seaocore_sidebar_list_details'>
              <?php echo $this->translate(array('%s Discussion', '%s Discussions', $sitereview->counttopics), $this->locale()->toNumber($sitereview->counttopics)) ?>,  
              <?php echo $this->translate(array('%s Reply', '%s Replies', $sitereview->total_count), $this->locale()->toNumber($sitereview->total_count)) ?>  
            </div>
       ...
       <li class="b_medium" style="width: <?php echo $this->columnWidth; ?>px;">
        <div class="sr_product_details" style="height:<?php echo $this->columnHeight; ?>px;">
          ...
          <div class="sr_ratingbar seaocore_txt_light">
            ...
            <?php if(in_array('reviewCount', $this->statistics) && ($listingtypeArray->reviews == 3 || $listingtypeArray->reviews == 2)):  ?>
            <span class="fright">
...
<?php else: ?>
  ...
  <div id="layout_sitereview_most_discussed_listings_<?php echo $this->identity;?>">
<!--    <div class="seaocore_content_loader"></div>-->
  ...
  <script type="text/javascript">
    ...
    var params = {
      ...
      'responseContainer' : 'layout_sitereview_most_discussed_listings_<?php echo $this->identity;?>',
