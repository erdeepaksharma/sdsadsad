 ...
 */
class Sitereview_Widget_UserRatingsController extends Seaocore_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (empty($listingtypeArray->reviews) || $listingtypeArray->reviews == 1 || !empty($listingtypeArray->allow_review)) {
      return $this->setNoRender();
    }
