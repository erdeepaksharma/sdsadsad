...
<?php if($this->is_ajax_load): ?>
  ...
  <?php if($this->category_id && !$this->subcategory_id && !$this->subsubcategory_id && !empty($this->showTopBottomContent)):?>
    <?php $catTopContent = Engine_Api::_()->getItem('sitereview_category', $this->category_id)->top_content;?>
  ...
  <?php elseif($this->subcategory_id && $this->category_id && !$this->subsubcategory_id):?>
    <?php $subcatTopContent = Engine_Api::_()->getItem('sitereview_category', $this->subcategory_id)->top_content;?>
  ...
  <?php elseif($this->subsubcategory_id && $this->category_id && $this->subcategory_id):?>
    <?php $subsubcatTopContent = Engine_Api::_()->getItem('sitereview_category', $this->subsubcategory_id)->top_content;?>
  ...
  <?php if ($this->paginator->count() > 0): ?>
              ...
              <div class='sr_browse_list_info'>  
                ...
                <?php if(!empty($sitereview->location) && $this->listingtypeArray->location): ?>
                  <div class='sr_browse_list_info_stat seaocore_txt_light'>
                    ...
                    - <b><?php echo  $this->htmlLink(array('route' => 'seaocore_viewmap', "id" => $sitereview->listing_id, 'resouce_type' => 'sitereview_listing'), $this->translate("Get Directions"), array('onclick' => 'owner(this);return false')) ; ?></b>
                  </div>
                <?php endif; ?>
    ...
    <?php if( $this->grid_view):?>
      <div id="image_view" class="sr_container" <?php if($this->defaultView !=1): ?>style="display: none;" <?php else:?>style="display: block;"<?php endif; ?>>
...
<?php else: ?>
  ...
  <?php
  echo $this->paginationControl($this->result, null, array("pagination/pagination.tpl", "sitereview"), array("orderby" => $this->orderby));
  ?>
<?php endif; ?>
