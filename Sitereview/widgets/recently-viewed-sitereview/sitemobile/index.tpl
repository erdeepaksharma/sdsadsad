			...
			<?php if ($this->listings->count() > 1): ?>
				<?php
					echo $this->paginationAjaxControl(
							$this->listings, $this->identity, 'list-view', array('count' => $this->count, 'truncation' => $this->title_truncation, 'viewType' => $this->viewType, 'ratingType' => $this->ratingType, 'statistics'=>$this->statistics, 'columnHeight' => $this->columnHeight));
				?>
			<?php endif; ?>
	</div>
<?php else: ?>
	<div class="ui-page-content">
		<div id="grid_view">
					...
					<li style="height:<?php echo $this->columnHeight ?>px;">
						<a href="<?php echo $sitereview->getHref(array('profile_link' => 1)); ?>" class="ui-link-inherit">
							...
							<div class="p_list_grid_title">
								<span><?php echo Engine_Api::_()->seaocore()->seaocoreTruncateText($sitereview->getTitle(), $this->title_truncation); ?></span>
							</div>
						</div>
			...
			<?php if ($this->listings->count() > 1): ?>
				<?php
					echo $this->paginationAjaxControl(
							$this->listings, $this->identity, 'grid_view', array('count' => $this->count, 'truncation' => $this->title_truncation, 'viewType' => $this->viewType, 'ratingType' => $this->ratingType, 'statistics'=>$this->statistics, 'columnHeight' => $this->columnHeight));
				?>
			<?php endif; ?>
		</div>
	</div>
...
.layout_sitereview_recently_viewed_sitereview > h3 {
	display:none;
}
