...
$breadcrumb = array(
	array("href"=>$this->listingType->getHref(),"title"=>$this->translate("$this->title_plural"),"icon"=>"arrow-r"),
	...
	array("title"=>$this->htmlLink($this->sitereview->getHref(), $this->sitereview->getTitle()),"icon"=>"arrow-r"),
	array("href"=>$this->url(array('listing_id' => $this->sitereview->listing_id, 'slug' => $this->sitereview->getSlug(), 'tab' => $this->tab_id), 'sitereview_entry_view_listtype_'.$this->listingtype_id, true), "title" => "Reviews", "icon"=>"arrow-r"),
