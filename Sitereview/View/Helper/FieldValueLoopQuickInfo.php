 ...
 */
class Sitereview_View_Helper_FieldValueLoopQuickInfo extends Fields_View_Helper_FieldAbstract {

  public function fieldValueLoopQuickInfo($subject, $partialStructure, $itemCount = 5) {
