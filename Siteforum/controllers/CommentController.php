 ...
 * @version    $Id: CommentController.php 6590 2015-12-23 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteforum_CommentController extends Core_Controller_Action_Standard {
    ...
    public function listAction() {
        ...
        $topic = $subject->getParent();
        $siteforum = $subject->getParent()->getParent();
        // Perms
        $this->view->canComment = $canComment = (!$topic->closed && Engine_Api::_()->authorization()->isAllowed($siteforum, null, 'post.create'));
    ...
    public function createAction() {
        ...
        $this->view->body = $this->view->action('list', 'comment', 'siteforum', array(
            'type' => $this->_getParam('type'),
    ...
    public function editAction() {
        ...
        $item = $this->view->comment = Engine_Api::_()->getItem('core_comment', $this->_getParam('comment_id'));

        $item->body = $this->_getParam('body');
        $item->save();
        $this->view->status = true;
        $this->view->body = $this->view->action('list', 'comment', 'siteforum', array(
            'type' => $this->_getParam('type'),
    ...
    public function likeAction() {
        ...
        $this->view->like_count = $subject->like_count;
        $this->view->status = true;
        $this->view->liked = true;
        $this->view->message = Zend_Registry::get('Zend_Translate')->_('Like added');
        return $this->_helper->json(array('like_count' => $this->view->like_count));
        //$this->_helper->contextSwitch->initContext();
    }
    ...
    public function unlikeAction() {
        ...
        $this->view->comment_id = $this->_getParam('comment_id');
